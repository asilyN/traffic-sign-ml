...
- 🧠 **Machine Learning**
  - scikit-learn traffic sign classifier
...
**Output files:**
- `server/app/ml/models/simple_classifier.joblib` - Your trained model
- `server/app/ml/dataset/reports/simple_train_metrics.txt` - Training metrics
...
└── server/                         # ── BACKEND (Flask + Python) ────────────────────────
    ...
    └── app/
        ...
        └── ml/
            ...
            │   │   └── simple_classifier.h5   #   Generated by training script
